...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_GAME] = LAYOUT_split_3x6_3(
        ...
        KC_LALT, KC_2, KC_A, KC_S,   KC_D,    KC_F,        /**/ KC_G,    KC_H,           KC_J,           KC_K,    KC_L,   KC_SCLN,
        KC_LCTL, KC_3, KC_T, KC_G,   KC_B,    KC_C,        /**/ KC_B,    KC_N,           KC_M,           KC_COMM, KC_DOT, KC_SLSH,
    ...
    [L_UA] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_P,    KC_U, KC_K,      KC_V,                     KC_COMM,       /**/ RALT_T(KC_QUES), RSFT_T(KC_SLSH), KC_Q, KC_M, KC_RBRC, KC_DOT,
